            ...
            {data.nav &&
              data.nav.map((item, i) => {
                ...
                return (
                  ...
                  >
                    <Link href={`${prefix}/${item.href}`} className={`relative select-none	text-base inline-block tracking-wide transition duration-150 ease-out hover:opacity-100 py-8 px-4 ${activeItem ? `` : `opacity-70`
                      }`}>
